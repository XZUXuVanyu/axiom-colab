...
public:
    ...
    [[nodiscard]] std::string create_workspace(
        std::string_view workspace_id, ResponseHandler handler);
    [[nodiscard]] std::string create_goal(
    ...
    [[nodiscard]] std::string decide_installation(
        ...
        ResponseHandler handler);
    [[nodiscard]] std::string install_candidate(
        std::string_view workspace_id, cpp_adapter::Json binding,
        ResponseHandler handler);
    ...
    [[nodiscard]] std::string create_candidate(
