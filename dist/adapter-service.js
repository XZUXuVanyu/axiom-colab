import { DescriptorLoader } from './descriptor-loader.js';
...
import { BridgeToolError, errorCode, makeToolCallRequest, parseToolCallResponse } from './protocol.js';
export class AdapterService {
    ...
    gate;
    disposed = false;
    constructor(runner, observer, config){
        this.runner = runner;
    ...
    async initialize(signal) {
        ...
        const descriptors = await new DescriptorLoader(this.runner, this.config.bridge, this.config.descriptorLimits, this.observer).load(signal);
...
//# sourceURL=file:///D:/Dev/axiom-colab/source/ts/adapter-service.ts